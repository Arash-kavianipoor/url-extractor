          ...
          <div className="flex items-center gap-2 flex-wrap shrink-0">
            <button
              ...
              onClick={() => {
                ...
                if (ok) {
                  showToast(t.downloadSingleStandaloneSuccess);
                } else {
                  showToast(t.toastStandaloneNotFound);
                }
              }}
              ...
              title={t.downloadStandaloneTooltip}
            >
              <Download className="w-4 h-4 text-indigo-400" />
              <span>{t.downloadSingleStandaloneBtn}</span>
            </button>
